...
export default function Gallery() {
  ...
  const images = [
    { src: "/gallery/fourth.jpg", alt: "Photo 1", caption: "Prom" },
    { src: "/gallery/budapest.JPG", alt: "Photo 2", caption: "Budapest, Hungary" },
    { src: "/gallery/eureka.JPG", alt: "Photo 3", caption: "EurekaHACKS 2025" },
    { src: "/gallery/veda@uw.jpg", alt: "Photo 4", caption: "Future UW Math Student <3" },  
    { src: "/gallery/fifth.jpg", alt: "Photo 5", caption: "Graduation" },
    { src: "/gallery/seniorsun.jpg", alt: "Photo 6", caption: "Senior Sunset" },
    { src: "/gallery/third.jpg", alt: "Photo 7", caption: "Pump Before Prom" },  
    { src: "/gallery/first.jpg", alt: "Photo 8", caption: "Battle of the Bands" },
    { src: "/gallery/food.JPG", alt: "Photo 9", caption: "Gluttony @Kerr Street Cafe" },
    { src: "/gallery/karma.JPG", alt: "Photo 10", caption: "Karma @ISP" },
    { src: "/gallery/park.jpg", alt: "Photo 11", caption: "Bike Ride!" },
    { src: "/gallery/port.JPG", alt: "Photo 12", caption: "Lisbon, Portugal" },
    { src: "/gallery/port2.jpg", alt: "Photo 13", caption: "Sunset in Lisbon" },
    { src: "/gallery/prag.jpg", alt: "Photo 14", caption: "Malostranska, Praha" },
    { src: "/gallery/croatia.jpg", alt: "Photo 15", caption: "Dubrovnik, Croatia" },
    { src: "/gallery/springfling.jpg", alt: "Photo 16", caption: "Slightly annoyed @Spring Fling" },  
    ...
    { src: "/gallery/fancycar.jpg", alt: "Photo 21", caption: "Porsche avec les arbres" },
